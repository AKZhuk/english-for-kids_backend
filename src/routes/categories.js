...
var categories_1 = require("../storage/categories");
var router = express_1.Router();
router.get('/getall', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var reqResult;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, categories_1.getAllCategories()];
            case 1:
                reqResult = _a.sent();
...
router.post('/add', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, categories_1.insertCategory(req.body)];
            case 1:
                reqResult = _a.sent();
                res.status(200).json(reqResult);
                return [2 /*return*/];
...
router.put('/update', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, _id, name, reqResult;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, _id = _a._id, name = _a.name;
                return [4 /*yield*/, categories_1.updateCategory(_id, name)];
            case 1:
                reqResult = _b.sent();
                res.status(200).json(reqResult);
                return [2 /*return*/];
...
router.delete('/delete', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _id = req.body._id;
                return [4 /*yield*/, categories_1.deleteCategory(_id)];
            case 1:
                deleted = _a.sent();
